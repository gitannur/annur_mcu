                                ...
                                <div class="col-lg-3">
                                    <div class="col mb-3">
                                        ...
                                        <select name="id_user" id="id_user"
                                            class="form-select custom-input form-select-sm select2"
                                            style="width: 200px; font-size: 10pt;">
                                            <option value="" style="font-size: 10pt">Pilih User</option>
                            ...
                            <div class="row gx-3">
                                ...
                                <div class="col-md-5">
                                    <div class="col mb-3">
                                        ...
                                        <input type="text" required class="form-control custom-input form-control-sm"
                                    ...
                                    <div class="col mb-3">
                                        <label for="id_daftar_penyakit" class="form-label">Pilih Jenis Penyakit </label>
                                        <select name="id_daftar_penyakit" id="id_daftar_penyakit" required
                                    ...
                                    <div class="col mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col mb-3">
                                                ...
                                                <textarea required class="form-control custom-input form-control-sm" name="head_to_toe" id="head_to_toe"
                                                    rows="3"></textarea>
                                            </div>
