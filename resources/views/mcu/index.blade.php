                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h5 class="text-white text-capitalize ps-3">Medical Check Up</h5>
                        </div>
                    </div>
                    <div class="card-body p-3 pb-2">
                        <div>
                            <a href="{{ route('mcu.create_lab') }}" class="btn btn-sm btn-primary">Lab-Input  </a>
                            <a href="{{ route('mcu.create_dokter') }}" class="btn btn-sm btn-primary">Dokter-Input </a>
                        </div>
                        <div class="">
                            <div class="mb-2">
                                    ...
                                    @foreach ($medicalcheckup as $mcu)
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                ...
                                                {{-- <a href="{{ route('mcu.edit', ['user' => $mcu->user->id, 'tahun' => \Carbon\Carbon::parse($mcu->tanggal_pemeriksaan)->year]) }}" class="btn btn-info btn-icon-only m-0 p-0 btn-sm">
                                                    <span class="btn-inner--icon">
                                                        <i class="fas fa-edit fa-lg"></i>
                                                    </span>
                                                </a> --}}
                                                ...
                                                {{-- Rangkuman hasil MCU  buat menu tersendiri di dashboard.  --}}
                                                ...
                                                <a href="#detail_lab{{ $mcu->id}}" data-bs-toggle="modal"
                                                    class="btn btn-success btn-icon-only m-0 p-0 btn-sm">
                                                    <span class="btn-inner--icon">
                                                        <i class="fas fa-eye fa-lg"></i>
                                                    </span>
            ...
            var table = $('#example_mcu').DataTable({
                ...
                initComplete: function() {
                    ...
                    this.api().columns().every(function() {
                        ...
                        if (column.index() === 2) { // Kolom Status
                        ...
                        } else if (column.index() === 5) { // Kolom Tanggal Check Up (tahun)
                            // var select = $('#tahunFilter')
                            //     .on('change', function() {
                            //         var val = $.fn.dataTable.util.escapeRegex($(this).val());
                            //         column.search(val ? '^' + val + '$' : '', true, false).draw();
                            //     });

                            // Ganti dengan kolom yang sesuai dengan tahun pada data Anda
                            // var uniqueYears = [2020,2021,2022,2023,2024,2025,2026];
                            ...
                            // select.append('<option value=""></option>'); // Tambahkan opsi kosong
